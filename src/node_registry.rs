...
fn get_trigger_nodes() -> Vec<NodeType> {
    vec![
        ...
        NodeType {
            id: "child_workflow_trigger".to_string(),
            label: "Child Workflow Trigger".to_string(),
            category: "Trigger".to_string(),
            description: Some("Trigger for child workflows, accepts injected inputs".to_string()),
            documentation: None,
            properties: vec![],
            outputs: vec![],
        },
...
fn get_action_nodes() -> Vec<NodeType> {
    let mut nodes = Vec::new();
    nodes.extend(get_network_nodes());
    nodes.extend(get_database_nodes());
    nodes.extend(get_filesystem_nodes());
    nodes.extend(get_utility_nodes());
    nodes.extend(get_control_nodes());
    nodes
}
...
fn get_logic_nodes() -> Vec<NodeType> {
    vec![
        ...
        NodeType {
            id: "switch".to_string(),
            category: "Logic".to_string(),
            label: "Multi-way Switch".to_string(),
            description: Some("Routes input based on value matching".to_string()),
            documentation: None,
            properties: vec![
                NodeProperty {
                    name: "expression".to_string(),
                    label: "Expression (Template)".to_string(),
                    property_type: "text".to_string(),
                    options: None,
                    default: None,
                    required: true,
                ...
                NodeProperty {
                    ...
                    label: "Cases (JSON Array)".to_string(),
                    property_type: "json".to_string(),
                    options: None,
                    default: Some("[\"case1\", \"case2\"]".to_string()),
                    required: true,
                    json_schema: None,
                },
            ],
            // Dynamic outputs depending on cases + 1 default
            outputs: vec![], 
        },
    ]
}
...
fn get_data_processing_nodes() -> Vec<NodeType> {
    vec![
        ...
        NodeType {
            ...
            documentation: Some("Collects items into an array. If 'batch_size' is set, emits array of that size. If not, waits for stream end.".to_string()),
            properties: vec![
                NodeProperty {
                    name: "batch_size".to_string(),
                    label: "Batch Size (Optional)".to_string(),
        ...
        NodeType {
            ...
            category: "Data Processing".to_string(),
            description: Some("Transform/Project data using Jinja2 templates".to_string()),
            documentation: Some("Use Jinja2 syntax. If output is valid JSON, it is parsed as object. Use 'Output Type' to force casting.".to_string()),
            properties: vec![
                NodeProperty {
                ...
                NodeProperty {
                    ...
                    label: "Output Type (Cast)".to_string(),
                    property_type: "select".to_string(),
                    options: Some(vec!["auto".to_string(), "string".to_string(), "number".to_string(), "boolean".to_string(), "json".to_string()]),
...
fn get_network_nodes() -> Vec<NodeType> { vec![
        NodeType {
            ...
            properties: vec![
                ...
                NodeProperty {
                    name: "auto_split".to_string(),
                    label: "Auto-Split Response Arrays".to_string(),
        ...
        NodeType {
            id: "ftp_op".to_string(),
            category: "Action".to_string(),
            label: "FTP Operation".to_string(),
            description: Some("Upload or Download files via FTP".to_string()),
            documentation: None,
            properties: vec![
                NodeProperty {
                    name: "host".to_string(),
                ...
                NodeProperty {
                    ...
                    property_type: "text".to_string(), // Secret
                    options: None,
                    default: None,
                    required: true,
                    json_schema: None,
                ...
                NodeProperty {
                    ...
                    property_type: "select".to_string(),
                    options: Some(vec!["upload".to_string(), "download".to_string()]),
                    default: Some("download".to_string()),
                    required: true,
                    json_schema: None,
                },
                NodeProperty {
        ...
        NodeType {
            id: "ssh_command".to_string(),
            category: "Action".to_string(),
            label: "SSH Command".to_string(),
            description: Some("Execute remote command via SSH".to_string()),
            documentation: None,
            properties: vec![
                NodeProperty {
                    name: "host".to_string(),
                ...
                // Private key option could be added later
                NodeProperty {
...
fn get_database_nodes() -> Vec<NodeType> { vec![
        NodeType {
            id: "sql_query".to_string(),
            category: "Action".to_string(),
            label: "SQL Query".to_string(),
            description: Some("Execute a SQL query against a database".to_string()),
            documentation: None,
            properties: vec![
                NodeProperty {
                    name: "connection_string".to_string(),
                    label: "Connection String".to_string(),
                    property_type: "text".to_string(), // In future, use 'secret' type
                    options: None,
                    default: None,
                    required: true,
                    json_schema: None,
                ...
                NodeProperty {
                    ...
                    label: "Parameters (JSON Array)".to_string(),
                    property_type: "json".to_string(),
                    options: None,
                    default: Some("[]".to_string()),
                    required: false,
...
fn get_filesystem_nodes() -> Vec<NodeType> { vec![
        NodeType {
            ...
            properties: vec![
                ...
                NodeProperty {
                    ...
                    label: "Stream Line-by-Line".to_string(),
                    property_type: "boolean".to_string(),
                    options: None,
        ...
        NodeType {
            ...
            description: Some("Write or append content to a file".to_string()),
            documentation: None,
            properties: vec![
                NodeProperty {
                    name: "path".to_string(),
                ...
                NodeProperty {
                    ...
                    label: "Mode".to_string(),
                    property_type: "select".to_string(),
                    options: Some(vec!["overwrite".to_string(), "append".to_string()]),
                    default: Some("overwrite".to_string()),
                    required: true,
                    json_schema: None,
                },
            ],
        ...
        NodeType {
            ...
            properties: vec![
                ...
                NodeProperty {
                    ...
                    label: "Glob Pattern (e.g. *.csv)".to_string(),
                    property_type: "text".to_string(),
                    options: None,
                    default: Some("*".to_string()),
                    required: false,
...
fn get_utility_nodes() -> Vec<NodeType> { vec![
        NodeType {
...
fn get_control_nodes() -> Vec<NodeType> { vec![
        NodeType {
            id: "delay".to_string(),
        ...
        NodeType {
            ...
            category: "Action".to_string(),
            description: Some("Return a value from the workflow".to_string()),
            documentation: None,
            properties: vec![
                NodeProperty {
                    name: "value".to_string(),
        ...
        NodeType {
            id: "execute_workflow".to_string(),
            label: "Execute Workflow".to_string(),
            category: "Action".to_string(),
            description: Some("Execute another workflow".to_string()),
            documentation: None,
            properties: vec![
                NodeProperty {
                    name: "workflow_path".to_string(),
                    label: "Workflow Path".to_string(),
                    property_type: "text".to_string(),
                    options: None,
                    default: None,
                    required: true,
        ...
        NodeType {
            id: "loop".to_string(),
            label: "Loop (Do-While)".to_string(),
            category: "Action".to_string(),
            description: Some("Execute a workflow repeatedly until a condition is met".to_string()),
            documentation: None,
            properties: vec![
                NodeProperty {
                    name: "workflow_path".to_string(),
                ...
                NodeProperty {
                    name: "condition_key".to_string(),
                    label: "Condition Key (JMESPath)".to_string(),
                    property_type: "text".to_string(),
                    options: None,
                    default: None,
                    required: true,
                ...
                NodeProperty {
                    name: "condition_operator".to_string(),
                    label: "Operator".to_string(),
                    property_type: "select".to_string(),
                    options: Some(vec!["==".to_string(), "!=".to_string(), ">".to_string(), "<".to_string(), ">=".to_string(), "<=".to_string(), "contains".to_string()]),
                    default: Some("==".to_string()),
        ...
        NodeType {
            id: "wait".to_string(),
            label: "Wait (Barrier)".to_string(),
            category: "Action".to_string(),
            description: Some("Waits for one item from EACH input before proceeding".to_string()),
            documentation: None,
            properties: vec![
                NodeProperty {
